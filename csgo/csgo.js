...
const pName = process.argv[2] || 'csgo.exe',
  ...
  dwLocalPlayer = 0x00A8C53C,
  dwViewMatrix = 0x04A9F804,
  dwEntityList = 0x04AADC64;

const localPlayer = new Entity(dwLocalPlayer, 1);
console.log(localPlayer.id, localPlayer.health, localPlayer.armor, localPlayer.team);
...
setInterval(()=>{
  if(activeClient && activeClient._socket){
    sendState(activeClient);
  }
}, 20);
